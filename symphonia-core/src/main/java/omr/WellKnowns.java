...
public class WellKnowns
{
    ...
    public static final String COMPANY_NAME = "Symphonia";

    /** Application company id: {@value}. */
    public static final String COMPANY_ID = "Symphonia";

    /** Application name: {@value}. */
    public static final String TOOL_NAME = "Symphonia UI";
...
//            ? toURI(
//            WellKnowns.class.getClassLoader().getResource("/"))
...
//                    .toUri();
    ...
    private static URI getClassContainer()
    {
        // TODO:
        try {
            return WellKnowns.class.getProtectionDomain().getCodeSource().getLocation().toURI();
    ...
    {
        // TODO: default to /tmp
        System.out.println("data.dir :" + System.getProperty("data.dir"));
        // user specified dir
        if (System.getProperty("data.dir") != null) {
            System.out.println("Setting data dir to " + System.getProperty("data.dir"));
            return new File(System.getProperty("data.dir"));
        }
    ...
    private static FileTime getJarTime()
    {
        ...
        /*
        JAR_FILE.getEntry("META-INF/MANIFEST.MF")
        .getTime();
        */
    ...
    private static void logDeclaredData()
    {
        ...
        if (!RUNNING_FROM_JAR) {
            ...
            logger.debug("JarTime: {} JarFile: {}", JAR_TIME, JAR_FILE);
        }
    ...
    {
        System.out.println("Class container: " + CLASS_CONTAINER.toString());
        boolean res = CLASS_CONTAINER.toString().toLowerCase().endsWith(".jar");
        System.out.println("Running from JAR: " + res);
        return res;
    }

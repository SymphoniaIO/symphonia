...
public class ActionManager
{
    ...
    public void loadAllDescriptors ()
    {
        ...
        URL[] urls = new URL[]{
                WellKnowns.class.getResource("/system-actions.xml")
            //TODO: new File(WellKnowns.CONFIG_FOLDER, "user-actions.xml").toURI().normalize()
            };
        ...
        for (int i = 0; i < urls.length; i++) {
            ...
            try {
                ...
                if (i == 0) {
                    ...
                    logger.error("Mandatory file not found {}", url);
                }
            } catch (JAXBException ex) {
                logger.warn("Error loading actions from " + url, ex);
            }
        }
    }

...
public class Language
{
    ...
    private static class SupportedLanguages
    {
        ...
        public SupportedLanguages ()
        {
            ...
            try (InputStream input = WellKnowns.class.getResourceAsStream(LANG_FILE_NAME)) {
                logger.info("Loading lang " + input);
                ...
                logger.error("Error loading language " + LANG_FILE_NAME, ex);
            }

...
public class ScoreXmlReduction
{
    ...
    public static void main (String... args)
            throws FileNotFoundException, IOException, JAXBException, MarshallingException
    {
    ...
    public String reduce ()
            throws JAXBException, IOException, MarshallingException
    {
        // Preloading of JAXBContext
        watch.start("Preloading JAXB Context");
        Marshalling.getContext(ScoreXmlReduction.class);
